...
SECRET_KEY = '9dyk5e$yjkzoh%6mm#op3ij=($3g1fjqk2p2omueez+!8xh5^t'
...
LOGIN_REDIRECT_URL = '/account/studentform/'
...
LOGIN_EXEMPT_URLS = (
    ...
    r'^account/reset_password/done/confirm/(?P<uidb64>[0-9A-Za-z]+)-(?P<token>.+)/$',
